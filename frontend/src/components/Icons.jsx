// -*- coding: utf-8 -*-
// Icones SVG modernes pour remplacer les emojis
...
export const IconHeart = ({ filled, size = 20 }) => (
...
export const IconStar = ({ filled, size = 20 }) => (
  <svg width={size} height={size} fill={filled ? '#f59e0b' : 'none'} stroke="#f59e0b" viewBox="0 0 24 24">
...
export const IconEmail = ({ size = 20 }) => (
  <svg width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const IconPhoto = ({ size = 20 }) => (
  <svg width={size} height={size} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export function IconTag({ size = 20, className = "" }) {
  return (
